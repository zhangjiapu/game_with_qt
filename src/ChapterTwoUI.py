...
class ChapterTwoMainUI(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(260, 470, 252, 51))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.formLayout = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.formLayout.setContentsMargins(0, 0, 0, 0)
        self.formLayout.setObjectName("formLayout")
        self.longitudeLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.longitudeLabel.setObjectName("longitudeLabel")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.longitudeLabel)
        self.longitudeLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.longitudeLineEdit.setObjectName("longitudeLineEdit")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.longitudeLineEdit)
        self.latitudeLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.latitudeLineEdit.setObjectName("latitudeLineEdit")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.latitudeLineEdit)
        self.latitudeLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.latitudeLabel.setObjectName("latitudeLabel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.latitudeLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_21.setText(_translate("MainWindow", "找到这个地方，然后输入它的坐标"))
